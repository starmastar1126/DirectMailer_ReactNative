  ...
  render() {
    ...
    return (  
      <TouchableOpacity activeOpacity={1} onPress={this.props.onClick}>
        <View style={{width: '100%', marginBottom: 10, paddingTop: 10, paddingBottom: 10, paddingLeft: 10, paddingRight: 10, flexDirection: 'row', borderBottomWidth: 1, borderColor: Global.RIGHT_BLUE_COLOR}}>
            ...
            <View style={{marginLeft: 10, flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                ...
                <View style={{height: 20, marginTop: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                    ...
                    <TouchableOpacity style={{width: 15, height: 15, backgroundColor: '#7B8D93', borderRadius: 18, alignItems: 'center'}} onPress={this.props.onPrice}>
