          ...
          <View style={{width: 50}}>
            {accountBtn === true ?     
              <Menu>
                ...
                <MenuOptions>
                  <View style={{flexDirection: 'row', paddingLeft: 5}}><Image source={mapIcon} style={{marginTop: 7, width: 30, height: 30}} /><MenuOption style={{width: '100%', height: 35, marginTop: 7}} onSelect={() => navigation.navigate('MyMapsPage')} text='My Maps'/></View><Divider style={{ backgroundColor: '#AAA' }} />
