...
class DesignPrintPage extends React.Component {   
    constructor (props) {
        super(props);
        this.state = {
            templateVisible: false, selectValue: 0, selectItem: 0,
    ...
    static navigationOptions = ({navigation}) => {
        return {header:(<Header headerTitle="Design & Print" navigation={navigation} navigate="SelectRoutesPage" backBtn={true} accountBtn={true} />)}
    }
    render() {
        return (
            ...
            <ScrollView style={styles.container}>
                ...
                <Card width={Global.VW*90}>
                    ...
                    <CardContent>
                        ...
                        <View style={{width: '100%', height: 250, paddingTop: 20, paddingLeft: 10, paddingRight: 10, flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                            ...
                            <ScrollView horizontal={true} style={{width: '100%', height: '100%'}}>
                                {templateData.map((item, key) => {
                                    return (
                                        <TouchableOpacity onPress={() => this.onShowTemplateDetail(key)}>
                        ...
                        <View style={{width: '100%', height: 150, paddingTop: 10, paddingLeft: 10, paddingRight: 10, flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
            ...
            <Dialog visible={this.state.templateVisible} width={Global.VW*90} top={130}>
                ...
                <DialogContent justifyContent='center' alignItems='center'>
                    {this.state.selectValue == 0 ?
                        <Image source={templateData[this.state.selectItem].front} resizeMode='contain' style={{borderWidth: 1, width: '100%', height: 200}} />
                    : this.state.selectValue == 1 ?
                        <Image source={templateData[this.state.selectItem].back} resizeMode='contain' style={{borderWidth: 1, width: '100%', height: 200}} />
                    : <View style={{borderWidth: 0, width: '100%', height: 200}} >
                        <Text style={{fontSize: 15, fontWeight: 'bold', padding: 10}}>{templateData[this.state.selectItem].category}</Text>
                        <Text style={{fontSize: 12, padding: 10}}>{templateData[this.state.selectItem].description}</Text>
                    </View>
                    }
    ...
    onShowTemplateDetail = (key) => {
        this.setState({templateVisible: true, selectItem: key, selectValue: 0})
    }
