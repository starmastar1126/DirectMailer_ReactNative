...
class TeamProfileResultsScreen extends React.Component {
        ...
        return (
            <View style={{backgroundColor: '#f5f5f5', alignItems: 'center'}}>
                <TeamProfileHeader
                    ...
                    selectedTab='TeamProfileResults'
                />
                <ScrollView style={{paddingHorizontal: wp('2%'), height: hp('45%')}}>
...
export default TeamProfileResultsScreen
