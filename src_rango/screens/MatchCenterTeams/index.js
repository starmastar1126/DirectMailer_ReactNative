            ...
            <View style={{backgroundColor: '#f6f8fa', alignItems: 'center'}}>
                ...
                <ScrollView style={{height: hp('45%')}}>
                    <View style={{paddingVertical: hp('2.0%'), flexDirection: 'column', justifyContent: 'center', alignItems: 'center'}}>
                        <TeamSelector
                            leftTeamName='KKR' selectedBackgroundColor='#382b70' leftTeamImage={require('../../assets/images/KKR.png')}
                        ...
                        />
                        <Text style={{marginTop: hp('2.0%'), alignSelf: 'center', fontWeight: '500', color: '#666', fontSize: hp('2.0%'), paddingVertical: hp('0.25%'), paddingHorizontal: wp('2.0%'), borderBottomColor: '#20d39b', borderBottomWidth: 1}}>
                            PLAYING XI
                        </Text>
